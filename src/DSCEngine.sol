...
contract DSCEngine is ReentrancyGuard {
     ...
     */
    function redeemCollateralForDsc(address tokenCollateralAddress, uint256 amountCollateral, uint256 amountDscToBurn) external moreThanZero(amountDscToBurn) isAllowedToken(tokenCollateralAddress) {
